...
if __name__ == "__main__":
    ...
    argslmnt = parser.parse_args()
    raw_data_np = np.loadtxt(argslmnt.infile)
    raw_data_np -= raw_data_np.mean()
    std_np=raw_data_np.std()
    psdfc=raw_data_np/std_np
    np.savetxt(argslmnt.outfile, psdfc, fmt='%.2e')
